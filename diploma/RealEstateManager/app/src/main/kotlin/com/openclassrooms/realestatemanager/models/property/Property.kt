...
data class Property(
    ...
    fun deepCopy(
        id: String = this.id, type: PropertyType = this.type, price: Int = this.price,
        ...
        interestPoints: MutableList<InterestPoint> =
            this.interestPoints.map { interestPoint -> interestPoint.deepCopy() }.toMutableList(),
        ...
        id, type, price, surface, rooms, bedRooms, bathRooms, description, address,
        ...
        fun fromContentValues(values: ContentValues?): Property {
            ...
            values?.let {
                ...
                if (it.containsKey(COLUMN_PROPERTY_TYPE)) {
                    property.type = PropertyType.valueOf(
                        it.getAsString(
                ...
                if (it.containsKey(COLUMN_INTEREST_POINTS)) {
                    property.interestPoints = InterestPointConverter().stringToInterestPoints(
                        it.getAsString(
                ...
                if (it.containsKey(COLUMN_PROPERTY_STATUS)) {
                    property.status = PropertyStatus.valueOf(
                        it.getAsString(
