...
public class CouleurPane
        extends
        YolaineComponentPane<CouleurModel, CouleurListener, CouleurEventPropertyName> {
    ...
    public CouleurPane(CouleurModel model) {
        super(model);
    }
    
    public CouleurPane(YolaineViewType viewType) {
        super(viewType);
    }
    
    public CouleurPane(CouleurModel model, YolaineViewType viewType) {
        super(model, viewType);
    }
    
    
    @Override
    protected CouleurModel createDefaultModel() {
        return new DefaultCouleurModel();
    }
    ...
    protected void installViewListeners() {
        ...
        nameField.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent evt) {
                Couleur oldValue = model.getCouleur();
                String newValue = nameField.getText();
                
                if (!ObjectUtils.equals(oldValue, newValue)) {
                    model.setCouleur(new Couleur(newValue));
                }
            }
    ...
    protected void initViewValues() {        
        nameField.setText(model.getCouleur().getCouleur());       
    }
    
    @Override
    protected CouleurListener createDefaultPropertyChangeHandler() {
        return new PropertyChangeHandler();
    }
    
    
    private class PropertyChangeHandler extends CouleurAdapter {
    ...
    public String toString() {
        ...
        if (model.getCouleur().getCouleur() != null && !model.getCouleur().getCouleur().equals("")) {
            text += " - " + model.getCouleur().getCouleur();
        }
