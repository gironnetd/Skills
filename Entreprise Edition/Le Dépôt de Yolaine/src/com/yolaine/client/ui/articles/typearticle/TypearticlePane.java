...
public class TypearticlePane
        extends
        YolaineComponentPane<TypearticleModel, TypearticleListener, TypearticleEventPropertyName> {
    ...
    public TypearticlePane() {
        super();
    }
    
    public TypearticlePane(TypearticleModel model) {
        super(model);
    }
    
    public TypearticlePane(YolaineViewType viewType) {
        super(viewType);
    }
    
    public TypearticlePane(TypearticleModel model, YolaineViewType viewType) {
        super(model, viewType);
    }
    
    
    @Override
    protected TypearticleModel createDefaultModel() {
        return new DefaultTypearticleModel();
    }
    ...
    @Override
    protected TypearticleListener createDefaultPropertyChangeHandler() {
        return new PropertyChangeHandler();
    }
    
    
    private class PropertyChangeHandler extends TypearticleAdapter {
