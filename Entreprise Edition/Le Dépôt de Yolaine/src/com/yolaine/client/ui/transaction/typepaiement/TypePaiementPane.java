...
import com.yolaine.client.ui.transaction.typepaiement.model.DefaultTypePaiementModel;
...
public class TypePaiementPane
        extends
        YolaineComponentPane<TypePaiementModel, TypePaiementListener, TypePaiementEventPropertyName> {
    ...
    public TypePaiementPane() {
        super();
    }
    
    public TypePaiementPane(TypePaiementModel model) {
        super(model);
    }
    
    public TypePaiementPane(YolaineViewType viewType) {
        super(viewType);
    }
    
    public TypePaiementPane(TypePaiementModel model, YolaineViewType viewType) {
        super(model, viewType);
    }
    
    
    @Override
    protected TypePaiementModel createDefaultModel() {
        return new DefaultTypePaiementModel();
    }
    ...
    protected void initViewValues() {        
        nameField.setText(model.getTypePaiement().getTypePaiement());
    }
    
    @Override
    protected TypePaiementListener createDefaultPropertyChangeHandler() {
        return new PropertyChangeHandler();
    }
    
    
    private class PropertyChangeHandler extends TypePaiementAdapter {
    ...
    public String toString() {
        ...
        if (model.getTypePaiement().getTypePaiement() != null && !model.getTypePaiement().getTypePaiement().equals("")) {
            text += " - " + model.getTypePaiement().getTypePaiement();
        }
